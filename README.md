...
~~~sh
# getting the code
git clone git@github.com:nko5/silentdistractions.git && cd ./silentdistractions/
...
# deploying to Modulus (to http://silentdistractions.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/silentdistractions" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
